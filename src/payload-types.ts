...
export interface Config {
  ...
  collectionsSelect: {
    ...
    cookingTechniques: CookingTechniquesSelect<false> | CookingTechniquesSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "cookingTechniques".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'cookingTechniques';
        value: number | CookingTechnique;
      } | null)
    | ({
        relationTo: 'ingredients';
        value: number | Ingredient;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "cookingTechniques_select".
 */
